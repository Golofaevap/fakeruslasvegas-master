...
// https://script.google.com/macros/s/AKfycbwSkYMhayPxiUKAI7JKm9FYvmWWT_qoFRHFDNAl2mogFxW3mpwmWjl7VXOTf-xMwKep/exec

const urlToPost =
    "https://script.google.com/macros/s/AKfycbxzFb07A_pPuxR6VnPY7D2-C2Zc2BlIJAY-KvzBYprYcdBdqp0fgsZsj0hLN3QJtDCJ/exec";
...
for (let i = 0; i < 100; i++) {
    ...
    const company = f.company.companyName();
    ...
    fakeRow.push(company + " in " + header1); // Company
